    ...
    <div class="container mx-auto px-4 lg:px-8">
        <div class="flex justify-between items-center h-16 sm:h-20">
            ...
            <nav class="hidden lg:flex items-center space-x-1">
                ...
                <a href="#" class="px-4 py-2 text-gray-700 hover:text-orange-500 font-medium rounded-lg transition-all duration-200 flex items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <a href="faq.html" class="px-4 py-2 text-gray-700 hover:text-orange-500 font-medium rounded-lg transition-all duration-200 flex items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div id="mobileMenu" class="lg:hidden hidden bg-white shadow-lg border-t border-gray-100">
        <div class="container mx-auto px-4 py-3">
            <div class="flex flex-col space-y-2">
                ...
                <a href="faq.html" class="px-4 py-3 text-gray-700 hover:text-orange-500 font-medium rounded-lg transition-all duration-200 flex items-center gap-3 border-b border-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd" />
                    </svg>
                    FAQ
